<style>
	...
	input[type='range'] {
		...
		/*横条的高度*/
		border-radius: 3px;
		background: var(--bs-global) !important;
	}
	...
	input[type="range"]::-webkit-slider-thumb {
		...
		cursor: pointer;
		border: 4px solid var(--bs-global);
		border-radius: 50px;
	}
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="form-group row configureproduct">
							...
							<div class="col-md-10 d-flex align-items-center" style="display: flex;position: relative;">
